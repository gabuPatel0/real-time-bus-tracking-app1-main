...
```bash
git remote add encore encore://real-time-bus-tracking-app-3pt2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/real-time-bus-tracking-app-3pt2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/real-time-bus-tracking-app-3pt2/settings/integrations/github)
